...
class book_add: #도서 등록하는 GUI를 출력하는 클래스
    ...
    def add_book(): # 등록 버튼을 눌렀을 때 등록한 도서의 정보가 원래 도서 리스트에 추가해 주는 메소드
...
class book_search: # 도서 조회 GUI를 출력하는 클래스
    ...
    #def get_book_show(): # 도서 조회시 도서를 선택했을 때 book show 클래스를 불러오는 메소드
...
class user_add: # 회원 등록 GUI를 출력하는 클래스
    ...
    def add_user(): # 등록 버튼을 누를시에 이름, 생년월일, 전화번호, 성별, 이메일, 사진의 정보를 받아 원래 회원 리스트에 추가해주는 메소드
        print(User.add_User_Info())

    #def search_photo(): # PC에서 사용자 사진을 찾도록 하는 메소드 --->> ?
...
class user_saerch: # 회원 조회 GUI를 출력하는 클래스
    ...
    #def get_user_show(): # 회원 조회 시 회원을 선택했을 때 book show 클래스를 불러오는 메소드
...
class user_show: # 선택한 회원 정보 GUI를 출력하는 클래스
    ...
    #def print_user_info(): # 조회한 회원의 정보 출력을 위한 메소드
...
class rent_user_search: # 도서 대출을 실행할 회원을 조회하는 GUI를 출력하는 클래스
    ...
    def update_rent_situation(): # 선택 버튼을 눌렀을 시에 해당 회원의 대출 여부가 도서 대출 중으로 바뀌어 저장하는 메소드
...
class rent_book_search: # 대출할 도서 정보 검색 GUI를 출력하는 클래스
    ...
    def update_rent_situation(): # 선택 버튼을 눌렀을 시에 대출 상태가 대출중으로 바뀌어 저장되게하고, 대출 정보 화면을 띄어주게 하는 메소드
...
class rent_show: # 대출 정보 GUI를 출력해주는 클래스
    ...
    def get_rent_book_info(): # 대출할 도서의 정보를 불러오는 메소드
    
    def get_rent_user_info(): # 대출할 회원의 정보를 불러오는 메소드
    
    def set_return_date(): # 반납 날짜를 지정하는 메소드
...
class rent state show: # 선택한 대출 정보 GUI를 출력해주는 클래스

    #def onClick(): # 클릭 이벤트 처리를 위한 메소드

    def book_return(): # 도서 반납 메소드
    
    def get_rent_book_info(): # 대출된 도서의 정보를 불러오는 메소드
    
    def get_rent_user_info(): # 대출을 실행한 회원의 정보를 불러오는 메소드
    
    def get_rent_info(): # 상단 대출 정보를 표시하는 메소드
"""
